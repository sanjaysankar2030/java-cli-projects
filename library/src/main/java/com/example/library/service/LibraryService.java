...
public class LibraryService {
    ...
    public void borrowBook(BorrowingRecord newBorrow) {
        newBorrow.setBorrowDate(LocalDate.now());
        newBorrow.setReturnDate(LocalDate.now().plusDays(14));
        borrowingRecords.add(newBorrow);
        //Decrease the number of books in the using the borrowing record
        Book book = newBorrow.getBook();
